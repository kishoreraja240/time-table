...
<table width="987" height="470" border="1">
  ...
  <?php 
						if(isset($_POST['addUser1']) && $_POST['examDate2']=="ALL") {
							 $select = $_POST['examDate2'];
							 echo $select;
							 $addMember2= $siteManagerDAO1->gettable($select);
							// print_r( $addMember2);
    ...
    <tr>
      ...
      <?php for($i=(sizeof($addMember2)/5);$i< 2*(sizeof($addMember2)/5);$i++){
								?>
									<td><?php echo $addMember2[$i]; ?> </td>
								<?php }
								?>
    </tr>
    <tr>
      <td height="73">Tuesday</td>
      <?php for($i=3*(sizeof($addMember2)/5);$i< 4*(sizeof($addMember2)/5);$i++){
								?>
									<td><?php echo $addMember2[$i]; ?> </td>
								<?php }
								?>
...
<?php for($i=4*(sizeof($addMember2)/5);$i< 5*(sizeof($addMember2)/5);$i++){
								?>
									<td><?php echo $addMember2[$i]; ?> </td>
								<?php }
								?>
...
<?php for($i=2*(sizeof($addMember2)/5);$i< 3*(sizeof($addMember2)/5);$i++){
								?>
									<td><?php echo $addMember2[$i]; ?> </td>
								<?php }
								?>    </tr>
    <tr>
      ...
      <?php for($i=0;$i<(sizeof($addMember2)/5);$i++){
								?>
									<td><?php echo $addMember2[$i]; ?> </td>
								<?php }
								?>
						...
						<?php  }
						else if(isset($_POST['addUser1']) && $_POST['examDate2']!="ALL" && $_POST['examDate2']!="---View---") {
							 $select = $_POST['examDate2'];
							 echo $select;
							 $addMember3= $siteManagerDAO1->gettable($select);
							 //print_r($addMember3);
...
<?php
							 ...
							 //$select = $_POST['examDate2'];
							 //$addMember2= $siteManagerDAO1->gettable();
							 //echo $addMember2;
